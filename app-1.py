...
# CONFIGURATION
# ------------------------------------------------------------
# ⚠️ Ton token — ne le partage jamais, même ici.
TOKEN = "REMETS_TON_TOKEN_ICI"
OWNER_ID = 1449856230238589159  # ton identifiant Discord

API_SECRET = "MonSecretBot2026XyzTest"
SITE_URL = "https://jules88.pythonanywhere.com"
...
if __name__ == "__main__":
    if not TOKEN:
        print("ERREUR : le token n'est pas défini.")
    else:
        bot.run(TOKEN)
